...
const HeroView = () => {
  return (
    <section className="relative flex w-full justify-center overflow-hidden bg-gradient-to-b from-[#8FD8C7] via-[#E6F6F1] to-[#FFFFFF] px-10 pt-50 md:px-20 xl:justify-start xl:px-25 2xl:px-30">
      <div className="relative mx-auto flex w-full max-w-[1920px] flex-col gap-50">
        <div className="z-10 flex flex-col gap-10">
          <h1 className="xl:5xl text-3xl font-[900] md:text-[42px] 2xl:text-6xl">
            SBMB 지갑 신청으로 <span className="text-[#E2A21D]">콘솔</span>{" "}
            전환과 <br className="hidden xl:block" /> 다양한 Web3 혜택을 경험해
            보세요.
          </h1>
        ...
        <img
          src={logo2XL}
          alt="logo"
          className="absolute right-0 hidden h-full w-auto object-contain 2xl:block"
        />
      </div>

      {/* Background Logo */}
      <div className="absolute top-50 right-0 flex h-full w-full items-start justify-end overflow-hidden">
        <img
          src={logoDefault}
          alt="logo"
